classdef MyBreachSimulinkSystem < MyBreachOpenSystem
    ...
    methods
        ...
        function this = MyBreachSimulinkSystem(mdl_name, params, p0, signals, inputfn, varargin)
            InitBreach();
        ...
        function Sim(this, tspan, U)
            switch nargin
                case 1
                    Sim@MyBreachOpenSystem(this);
                case 2
                    Sim@MyBreachOpenSystem(this, tspan);
                case 3
                    Sim@MyBreachOpenSystem(this, tspan, U);
            end
        ...
        function U = InitU(this,pts,tspan)
            ...
            U = InitU@MyBreachOpenSystem(this,pts,tspan);
            if ~isnan(U.t)
