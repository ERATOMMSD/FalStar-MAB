function [val, tau] = My_STL_Eval(Sys, phi, signalID, P, trajs, varargin)
...
if ischar(phi)
    ...
    [val__, time_values__] = My_STL_EvalThom(Sys, phi_tmp__, signalID, P, trajs, t);
...
switch nargin
    case 5
        [val, tau] = My_STL_EvalThom(Sys, phi, signalID, P, trajs);
    case 6
        if ~ischar(varargin{1})
            [val, tau] = My_STL_EvalThom(Sys, phi, signalID, P, trajs, varargin{1});
